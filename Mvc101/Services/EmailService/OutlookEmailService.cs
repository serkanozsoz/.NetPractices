...
namespace Mvc101.Services.EmailService
{
    ...
    {
        public string SenderMail => "wissen.akademie@outlook.com"; // outlook gmail ile değiştir(gmail ile göndermek için)
        public string Password => "1-9x2+abc";
        public string Smtp => "smtp-mail.outlook.com";  //gmail farklı (smtp.gmail.com)
